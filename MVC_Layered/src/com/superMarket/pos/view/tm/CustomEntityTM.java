...
public class CustomEntityTM {
    ...
    public CustomEntityTM(String itemCode, String description, String packSize, int qtyOnHand, BigDecimal unitPrice, int orderQty, BigDecimal sumOfTotal) {
    ...
    public CustomEntityTM(String orderDate, String orderId, String cusId, String itemCode, String description, BigDecimal unitPrice, int orderQty, BigDecimal discount, BigDecimal sumOfTotal) {
